...
if __name__ == "__main__":
    ...
    # Print detailed info for first location with measurements
    print("\nDetailed data for first location with recent measurements:")
    for location in locations_data:
        if location.get('latest_measurements'):
            # Print only if we have recent measurements
            if any(measurement for measurement in location['latest_measurements']):
